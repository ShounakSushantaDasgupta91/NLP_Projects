...
# installed.
TCL_PREFIX='D:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library\include'
...
TCL_PACKAGE_PATH='D:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Udemy Courses/Complete Data Science,Machine Learning,DL,NLP Bootcamp/Projects/Assignment_35/venv_SSD_V1\Library\lib\tclstub86.lib'
